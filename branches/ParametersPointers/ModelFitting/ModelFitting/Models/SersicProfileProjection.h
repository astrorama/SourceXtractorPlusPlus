...
public:
  ...
  SersicProfileProjection(std::shared_ptr<BasicParameter> i0, 
  ...
  SersicProfileProjection(const SersicProfileProjection& other)
            : m_i0{other.m_i0}, m_n{other.m_n}, m_k{other.m_k},
              m_i0_updater{other.m_i0_updater.getParameter().lock(), m_i0},
              m_n_updater{other.m_n_updater.getParameter().lock(), m_n},
              m_k_updater{other.m_k_updater.getParameter().lock(), m_k} { }
