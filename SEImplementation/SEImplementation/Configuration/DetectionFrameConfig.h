 ...
 * @brief Provides combined detection frame
 *
 */
class DetectionFrameConfig : public Euclid::Configuration::Configuration {
 public:
  ...
  explicit DetectionFrameConfig(long manager_id);
