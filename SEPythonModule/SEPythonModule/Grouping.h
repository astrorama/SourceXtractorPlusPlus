...
#ifndef SOURCEXTRACTORPLUSPLUS_GROUPING_H
#define SOURCEXTRACTORPLUSPLUS_GROUPING_H
...
private:
  ...
  std::shared_ptr<SourceXtractor::SourceGrouping> m_grouping;
};

}  // namespace SourceXPy

#endif  // SOURCEXTRACTORPLUSPLUS_GROUPING_H
