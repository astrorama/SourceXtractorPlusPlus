/**
 * @file DataModel/PropertyId.h
 * @date 05/17/16
 * @author mschefer
 */

#ifndef _DATAMODEL_PROPERTYID_H
#define _DATAMODEL_PROPERTYID_H
...
template <>
struct hash<DataModel::PropertyId>
{
  std::size_t operator()(const DataModel::PropertyId& id) const {
