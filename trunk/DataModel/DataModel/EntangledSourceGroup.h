/**
 * @file DataModel/EntangledSourceGroup.h
 * @date 05/09/16
 * @author mschefer
 */

#ifndef _DATAMODEL_ENTANGLEDSOURCEGROUP_H
#define _DATAMODEL_ENTANGLEDSOURCEGROUP_H
...
public:
  ...
  static std::shared_ptr<EntangledSourceGroup> create(std::vector<std::shared_ptr<Source>> sources,
      std::shared_ptr<TaskRegistry> task_registry) {
  ...
  virtual const std::vector<std::shared_ptr<SourceInterface>> getSources() const;
