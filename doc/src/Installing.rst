...
--------------
Installing the SExtractor++ source package on Ubuntu 19.04
----------------------------------------------------------

The follwing ios a protokol for the installation of the entire SExtractor++ on a Ubuntu-19.04 system which was freshly installed as a virtual machine.

1. Install necessary libraries
the following packages are necessary to run SExtractor++:
...
* "-DUSE_SPHINX=OFF" switches the sphinx documentation system off, which is not necessary to use and develop SExtractor++. Though python3-sphinx is installed, cmake reported an error with sphinx, and switching it off is the easiest solution.
...
5. Download and install SExtractor++::
...
6. Start working with SExtractor++

   After the binaries are now compiled and available, the SExtractor++ can be run with::
