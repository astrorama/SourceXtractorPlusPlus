...
Besides :ref:`isophotal <flux_iso_def>`, |PSF| and :ref:`model-fitting <models_def>` flux estimates, |SourceXtractor++| can currently perform two types of flux measurements: :ref:`fixed-aperture <flux_aper_def>` and :ref:`adaptive-aperture <flux_auto_def>`.
...
Almost all |SourceXtractor++| measurements are done using background-subtracted pixel values.
