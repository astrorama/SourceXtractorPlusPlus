...
struct InterpolatedImageFixture {
  std::shared_ptr<VectorImage<SeFloat>> m_image;

  InterpolatedImageFixture() {
...
BOOST_FIXTURE_TEST_CASE (InterpolatedImage_all_good_test, InterpolatedImageFixture) {
...
BOOST_FIXTURE_TEST_CASE (InterpolatedImage_bad_column_test, InterpolatedImageFixture) {
...
BOOST_FIXTURE_TEST_CASE (InterpolatedImage_bad_first_column_test, InterpolatedImageFixture) {
  auto variance = VectorImage<SeFloat>::create(4, 4, std::vector<SeFloat>{
    5., 1., 1., 1.,
    5., 1., 1., 1.,
    5., 1., 1., 1.,
...
BOOST_FIXTURE_TEST_CASE (InterpolatedImage_bad_wide_column_test, InterpolatedImageFixture) {
  auto variance = VectorImage<SeFloat>::create(4, 4, std::vector<SeFloat>{
    1., 5., 5., 1.,
    1., 5., 5., 1.,
    1., 5., 5., 1.,
...
BOOST_FIXTURE_TEST_CASE (InterpolatedImage_bad_row_test, InterpolatedImageFixture) {
  auto variance = VectorImage<SeFloat>::create(4, 4, std::vector<SeFloat>{
    1., 1., 1., 1.,
    1., 1., 1., 1.,
    5., 5., 5., 5.,
...
BOOST_FIXTURE_TEST_CASE (InterpolatedImage_bad_first_row_test, InterpolatedImageFixture) {
  auto variance = VectorImage<SeFloat>::create(4, 4, std::vector<SeFloat>{
    5., 5., 5., 5.,
    1., 1., 1., 1.,
    1., 1., 1., 1.,
...
BOOST_FIXTURE_TEST_CASE (InterpolatedImage_bad_wide_row_test, InterpolatedImageFixture) {
  auto variance = VectorImage<SeFloat>::create(4, 4, std::vector<SeFloat>{
    1., 1., 1., 1.,
    5., 5., 5., 5.,
    5., 5., 5., 5.,
...
BOOST_FIXTURE_TEST_CASE (InterpolatedImage_bad_no_gap_test, InterpolatedImageFixture) {
  auto variance = VectorImage<SeFloat>::create(4, 4, std::vector<SeFloat>{
    1., 1., 1., 1.,
    1., 1., 5., 1.,
    1., 1., 5., 1.,
